...
import { Copy, Share2, ThumbsUp, ThumbsDown, MoreVertical, Sprout } from "lucide-react";
...
interface PoolHeaderProps {
  ...
  showFarmingActive?: boolean;
}

export const PoolHeader = ({ poolData, showFarmingActive = false }: PoolHeaderProps) => {
  ...
  return (
    <>
              ...
              <div className="flex items-center gap-2 mb-2 flex-wrap">
                ...
                {showFarmingActive && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-green-500/10 hover:bg-green-500/20 border border-green-500/30 transition-colors cursor-pointer"
                  >
      ...
      {showFarmingActive && (
        <FarmingModal open={farmingModalOpen} onOpenChange={setFarmingModalOpen} />
      )}
    </>
  );
};
